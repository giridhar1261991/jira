import psycopg2
from common.data_extractor_dao import dbConnection, executeQuery, executeQueryReturnId, executeQueryAndReturnDF
from common.send_notification import send_completion_mail, send_start_mail
...
def getLastsuccessfulExtarctionDate():
    ...
    subtaskid = createSubTask(
        "get last successful data extraction date", maintaskid)
    conn = dbConnection()
    try:
        cur = conn.cursor()
        cur.execute(
